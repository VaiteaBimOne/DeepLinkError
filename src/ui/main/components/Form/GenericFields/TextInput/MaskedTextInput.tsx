...
const MaskedTextInput: React.FunctionComponent<Props> = ({
  disabled,
  error,
  rightIcon,
  leftIcon,
...
const StyledTextInput = styled(MaskInput)<{ isMultiline?: boolean; hasLeftIcon: boolean }>`
  ${(props) => props.theme.fonts.text.body.center};
  padding-vertical: ${(props) => props.theme.metrics.spacing[2]}px;
